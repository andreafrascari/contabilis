 ...
 */
public class OperatorCalendarModule extends DefaultModule 
{
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(OperatorCalendarModule.class);
	...
	{
		return CHANGE_MONTH_LINK.replace("@MODULE@", getDefaultName());
	}
